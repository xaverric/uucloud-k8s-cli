...
const cmdArgumentsDefinition = [
  {
    ...
    defaultOption: true,
    type: String,
    description: 'check, print, update, logs, scaleUp, scaleDown, overview, help commands. All these can be used as default commands without providing --command argument.'
  },
  {
    name: 'config',
    alias: 'c',
